<h2><a href="https://www.geeksforgeeks.org/problems/multiply-2-matrices4144/1?page=1&category=Matrix&sortBy=difficulty">Multiply 2 matrices</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">For 2 given matrices&nbsp;of size n x n. Your task is to multiply them.</span><br>&nbsp;</p>
